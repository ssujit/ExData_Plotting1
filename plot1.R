...
plot1.data <-read.table(sourceData, sep = ";", header = TRUE, stringsAsFactors = FALSE, dec = ".")


# subsetting data witin dates 2007-02-01 and 2007-02-0

subsetplot1.data <- plot1.data[plot1.data$Date %in% c("1/2/2007","2/2/2007"),]

# checking varriable class and convert to numeric
names(subsetplot1.data)
str(subsetplot1.data)
globalActivepower <- as.numeric(subsetplot1.data$Global_active_power)
